...
Her adımda, çevirdiğiniz modülün testlerini yazıp çalıştırarak ilerleyin. Bağımlılık sırasına uymak, derleme ve hata ayıklama sürecini kolaylaştıracaktır.
